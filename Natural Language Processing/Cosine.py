...
def load_docs():
    print("Loading docs...")
    doc1 = ('d1', 'text analytics is a important branch of computer science in discover meaningful information.')
    doc2 = ('d2', 'machine learning is also a branch of computer science.')
    doc3 = ('d3', 'text analytics and machine learning are branches of data science.')
...
text2 = 'd2'
text3 = 'd3'
cosine12 = get_cosine(text1, text2)
cosine13 = get_cosine(text1, text3)
cosine23 = get_cosine(text2, text3)
